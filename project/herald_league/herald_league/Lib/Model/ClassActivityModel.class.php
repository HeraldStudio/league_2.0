...
class ClassActivityModel extends Model
{
		...
		public function getClass($id)
		{
				...
				return $this->where("activity_id=$id")->field('class_id')->select();
		}

		public function getActivityByClass($class)
		{
			$class = intval($class);
			return $this->where("class_id=$class")->field('activity_id')->select();
		}
}
?>