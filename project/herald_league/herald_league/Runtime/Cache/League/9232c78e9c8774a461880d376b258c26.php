...
<link rel="stylesheet" type="text/css" href="__Public__/Css/danganshi2.css"/>
<style type="text/css">
a:link {
	color: #fff;
}
  ...
  <div id="main">
	...
	<div id="main_body">
	  <div id="main_body_inner">
	    <div id="danganshi">
		  <iframe name="i" src="__APP__/League/Home/infoRoom/leagueid/<?php echo ($leagueid); ?>"></iframe>
		  <div id="inner_right">
