...
<script language="javascript">
	window.onload = function() {
		...
		var pageup = document.getElementById("more3");
		var pagedown = document.getElementById("more4");
		...
		if(div2.style.display=='none'){
			...
			else{ul1.style.left = ''+(parseInt(ul1.style.left)+242)+'px';}
		}
		if(div1.style.display=='none'){
			if(parseInt(ul2.style.left)==0){}
			else{ul2.style.left = ''+(parseInt(ul2.style.left)+242)+'px';}
			}
		}
		pagedown.onclick = function(){
		if(div2.style.display=='none'){
			if(parseInt(ul1.style.left)==-484){}
			else{ul1.style.left = ''+(parseInt(ul1.style.left)-242)+'px';}
			}
		if(div1.style.display=='none'){
			if(parseInt(ul2.style.left)==-484){}
			else{ul2.style.left = ''+(parseInt(ul2.style.left)-242)+'px';}
		}
		}
	}
