...
EDiaryEditor = {
	...
	initView: function (sParentID) {
		...
		var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 621px;'>\
				<div id='EDiaryEditorToolBar' style='position: relative; width: 621px; height: 69px; background-image: url(../../../../../Public/Images/editor/editor/toolbar_bg.gif);'>\
				...
				<div style='width: 621px; height: 25px; background-image: url(../../../../../Public/Images/editor/editor/title_bg.gif);'>\
				</div>\
				<div style='height: 300px; background-image: url(../../../../../Public/Images/editor/editor/guage.gif); padding-left: 39px; width: 582px!important ; width: 621px;' id='EDiaryEditorContent'>\
				...
				<div style='width: 621px; height: 59px; background-image: url(../../../../../Public/Images/editor/editor/editor_foot.gif)'>\
				...
				if(key == "Family") {
					...
					if(key2 == 0) {// head
						_toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 78px; display: none;' id='EDiaryEditorFontFamilyItem'>\
								<div style='text-align: center; height: 20px; background-image: url(../../../../../Public/Images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>字体</b></div>\
									<div style=' height: 296px!important ;height: 290px; background-image: url(../../../../../Public/Images/editor/menu_bg.gif);' id='EDiaryEditorFontFamilyBox'>\
						";
					}
					...
					if(key2 + 1 == _toolMenuInfo[key].length) {// foot
						_toolbarStr3 += "\
								...
								<div style='height: 10px; background-image: url(../../../../../Public/Images/editor/menu_foot.gif); font-size: 1px;'></div>\
							</div>\
						";
					}
				}
						...
						_toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 175px; display: none;' id='EDiaryEditorFontSizeItem'>\
								<div style='text-align: center; height: 20px; background-image: url(images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>字号</b></div>\
									<div style='height: 388px!important ;height: 306px; background-image: url(../../../../../Public/Images/editor/menu_bg.gif);' id='EDiaryEditorFontSizeBox'>\
						";
					}
					if(key2 < _toolMenuInfo[key].length) {// body
						...
						_toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 243px; display: none;' id='EDiaryEditorFontStyleItem'>\
								<div style='text-align: center; height: 20px; background-image: url(images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>段落</b></div>\
									<div style='height: 231px!important ;height: 187px; background-image: url(../../../../../Public/Images/editor/menu_bg.gif);' id='EDiaryEditorFontStyleBox'>\
						";
					}
					if(key2 < _toolMenuInfo[key].length) {// body
		...
		var _toolbarStr5 = "\
			<div style='position: absolute; background-image: url(../../Im../../../../../Public/Images/images/blank.gif); left: 0px; top: 0px; width: " + $("EDiaryEditor").offsetWidth + "px; height: " + $("EDiaryEditor").offsetHeight + "px; display: none;' id='EDiaryEditorDialog'>\
				<div style='position: absolute; background-image: url(../../../../../Public/Images/editor//dilog_bg.gif); left: 160px; top: 140px; width: 310px; height: 157px; display: none;' id='EDiaryEditorIMGDialog'>\
				<iframe src='../../../../../Public/Images/editor/editor/img.html'></iframe>\
				</div>\
			</div>\
		";
		...
		for(var i = 0; i < 6; i ++) {
			for(var j = 0; j < 6; j++) {
				_toolbarStr6 += ("<img src='../../../../../Public/Images/editor/editor/blank.gif' onclick='EDiaryEditor.runCMD(\"forecolor\", \"" + c[k] + "\");' style='background: " + c[k] + ";border: 1px solid #999; margin: 0px; padding: 0px; margin-top: 1px; margin-left: 1px; width: 14px; height: 14px; cursor: hand; cursor: pointer;' />");
				k ++;
			}
			_toolbarStr6 += ('<br />');
		}
		...
		for(var i = 0; i < 6; i ++) {
			for(var j = 0; j < 6; j++) {
				_toolbarStr7 += ("<img src='../../../../../Public/Images/editor/editor/blank.gif' onclick='EDiaryEditor.runCMD(\"hilitecolor\", \"" + c[k] + "\");' style='background: " + c[k] + ";border: 1px solid #999; margin: 0px; padding: 0px; margin-top: 1px; margin-left: 1px; width: 14px; height: 14px; cursor: hand; cursor: pointer;' />");
				k ++;
			}
			_toolbarStr7 += ('<br />');
		}
		...
		var _toolbarStr8 = "<div style='position: absolute; left: 312px; top: 66px; display: none;' id='EDiaryEditorfaceItem'>\
			<img border='0' src='../../../../../Public/Images/editor/face_bg.gif' usemap='#Map' align='center'  style='cursor: hand; cursor: pointer;'/>\
			<map name='Map'>\
		...
		var _toolbarStr9 = "<div style='position: absolute; left: 0px; top: 0px; width: 621px; background: url(../../../../../Public/Images/editor/editor/blank.gif); height: 69px; display: none;' id='EDiaryEditorToolBarMask'></div>";

		this.addHTML($("EDiaryEditorToolBar"), _toolbarStr9);	

		var _toolbarStr9 = "<div style='position: absolute; left: 483px; top: 41px; display: none;' id='EDiaryEditorRsave' title='恢复上一次未成功发表内容'><img src='../../../../../Public/Images/editor/rsave.gif' csrc='../../Images/rsave.gif' bsrc='../../Images/rsave_over.gif' onmouseover='this.src=this.bsrc' onmouseout='this.src=this.csrc'></div>";
		this.addHTML($("EDiaryEditorToolBar"), _toolbarStr9);
		
		
		var _toolbarStr4 = "\
			<div style='position: absolute; width: 198px; height: 95px; top: 66px; left: 421px; display: none; background-image: url(../../../../../Public/Images/editor/justifyformat_bg.gif);' id='EDiaryEditorJustifyFormatItem'>\
	...
	initControl: function (bWordMode, sContent) {
		...
		function viewDialog(el, Act) {
			...
			if(window._isIE) {
				...
				if(Act == "attach") {
					window.showModalDialog("editor/attach.htm", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
				}
			}
			else {
				if(Act == "img") {
				...
				if(Act == "attach") {
					win = window.open("editor/attach.htm", null, "Width=400,Height=200");
					win.dialogArguments = window;
				}
			}
		...
		for(var key in this.config.node) {
			...
			_imgArr[key].src = "../../../../../Public/Images/editor/editor/"+key+".gif" ;
			_imgArr[key + "_over"] = new Image;
			_imgArr[key + "_over"].src = "../../../../../Public/Images/editor/editor/" + key + "_over.gif";
	...
	runCMD: function (CMD, sValue) {
		...
		if(CMD == "" || CMD == null)return;
			...
			var html = "<a href='http://www.baidu.com/s?tn=guilin86_pg&fyb=1&wd=" + rng.text + "' target='_blank'>" + rng.text  + "</a>";
			if(window._isIE) {
