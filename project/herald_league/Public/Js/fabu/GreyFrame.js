...
//    bgIframe.style.backgroundColor = "gray";
    ...
    titleDiv.style.cssText = 'color: #ffffff; background-color: #f4f4f4; text-align: center; border-bottom: 1px solid #e5e8ea; ';
    ...
    titleSpan.style.cssText = 'padding: 2px 2px; word-wrap: nowrap; color: #fd9030; float:left; line-height:32px; font-weight:bold; ';
    titleSpan.innerHTML = "活动发布";
