<?php if (!defined('THINK_PATH')) exit(); if(is_array($userData)): $i = 0; $__LIST__ = $userData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src = "__Uploads__/<?php echo ($vo['user_avatar_add']); ?>"/><br/>
